    ...
    $.AdminLTE.layout = {
        ...
        fix: function() {
            ...
            var a = $(".main-footer").outerHeight() || 0,
                ...
                c = $(window).height(),
                d = $(".sidebar").height() || 0;
            if ($("body").hasClass("fixed")) $(".o_main_content, .right-side").css("min-height", c - a);
            else {
                var e;
                c >= d ? ($(".o_main_content, .right-side").css("min-height", c - b), e = c - b) : ($(".o_main_content, .right-side").css("min-height", d), e = d);
                var f = $($.AdminLTE.options.controlSidebarOptions.selector);
                "undefined" != typeof f && f.height() > e && $(".o_main_content, .right-side").css("min-height", f.height())
            }
        },
        fixSidebar: function() {
        ...
        activate: function() {
            ...
            a._fix(e), $("body").hasClass("fixed") ? a._fixForFixed(c) : $(".o_main_content, .right-side").height() < c.height() && a._fixForContent(c)
        },
        open: function(a, b) {
        ...
        _fixForContent: function(a) {
            $(".o_main_content, .right-side").css("min-height", a.height())
        }
    }, $.AdminLTE.boxWidget = {
